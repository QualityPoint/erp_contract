...
Contract was created and submitted, those Payment Ledger Entry rows already exist. No
...
```
Day 1  Customer pays 50% via Payment Entry
         └─ PLE row written: against_voucher_no = "SAL-ORD-2026-0001"
...
`recalculate_contract_payment()` joins ERP Contract to PLE via `sales_order`. Without a
linked SO there are no PLE entries to find. The guard avoids a pointless DB round-trip.

---

## What This Handler Does NOT Do

- It does not query PLE directly.
